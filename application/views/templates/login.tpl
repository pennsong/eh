		...
		<div class="container">
			...
			<form id="loginForm" action="{url type='site' url='login/submit_validate'}" method="post">
				...
				<div class="clear prepend-19">
					...
					<!--{else}-->
					<input class="span-2 validate[required]" type="radio" name="type" id="typeHunter" value="hunter"/>
					<!--{/if}-->
					...
					<input class="span-2 validate[required]" type="radio" name="type" id="typeCompany" value="company" checked="checked"/>
					<!--{else}-->
					<input class="span-2 validate[required]" type="radio" name="type" id="typeCompany" value="company"/>
					<!--{/if}-->
					<div class="inline span-3">
						<div class="label1">
							公司
